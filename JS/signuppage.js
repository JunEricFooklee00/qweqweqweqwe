...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const NextButtons3 = document.querySelector(".next2");
  
    NextButtons3.addEventListener("click", function(event) {
      const current_fs = this.parentNode;
      const next_fs = this.parentNode.nextElementSibling;
      const progressBar = document.querySelectorAll("#progressbar li");
    ...
    var current_fs, next_fs, previous_fs; //fieldsets
    var opacity;
    const prevButtons1 = document.querySelector(".previous1");
        prevButtons1.addEventListener("click", function() {
